      ...
      <div className="container mx-auto w-full sm:w-[96%] px-6 border drop-shadow-2xl shadow-2xl mt-5 rounded-xl">
        ...
        <form>
          ...
          <input
            ...
            required
            placeholder="Email.."
            className="peer w-full border-0 border-b-2 border-gray-300 focus:border-blue-500 focus:outline-none focus:ring-0 transition duration-300 ease-in-out px-2 py-1 placeholder-gray-500 block mt-4 lg:mt-4 rounded-md py-2"
          />
