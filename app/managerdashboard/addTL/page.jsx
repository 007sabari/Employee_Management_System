...
const Register = () => {
  return (
    <div className="p-5">
      <div className="container mx-auto w-full sm:w-[70%] px-2 border drop-shadow-2xl shadow-2xl mt-2 lg:mt-2 rounded-xl">
        <h1 className="text-blue-800  text-center my-6 rounded-xl w-full sm:w-[96%] mx-auto font-black font-sans text-2xl">
          Add TL / Manager
        </h1>
        <form>
          <input
            ...
            placeholder="Name.."
            required
            className="w-full border-0 border-b-2 border-gray-300 focus:border-blue-500 focus:outline-none focus:ring-0 transition duration-300 ease-in-out px-2 placeholder-gray-500 block mt-11 lg:mt-4 rounded-md py-2"
          />
          ...
          <label htmlFor="Role" className="block my-1 text-sm mt-4 lg:mt-4">
            Role:
          </label>
          <div className="flex items-center mt-4 lg:mt-4">
            <input
